...
swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper.use([swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Thumbs, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.FreeMode]);
window.addEventListener("DOMContentLoaded", e => {
  ...
  //   spaceBetween: 10,
  // });
  const thumbsSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".interview__thumbs", {
    slidesPerView: 4,
    spaceBetween: 10,
    breakpoints: {
      320: {
  ...
  const interviewSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__.Swiper(".interview__slider", {
    slidesPerView: 1,
    spaceBetween: 20,
    thumbs: {
      swiper: thumbsSlider
